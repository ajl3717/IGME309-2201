...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	if (a_event.key.code == sf::Keyboard::Key::Escape)//Event says I pressed the Escape key
		...
		complimentColor = !complimentColor;
}
void AppClass::Display(void)
{
	...
	GLuint ComplimentaryColor = glGetUniformLocation(m_uShaderProgramID, "ComplimentColor");
	glUniform1i(ComplimentaryColor, complimentColor);
